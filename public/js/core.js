...
var P_FULL = [
  ...
  { id: 'oc-main', name: '颖姗（主Agent）', icon: 'fa-brain', color: '#3b6df0', step: 0, desc: '主科研助手', navBreak: 'OpenClaw' },
  { id: 'wiki', name: 'Wiki 知识库', icon: 'fa-book', color: '#10b981', step: 0, desc: 'agent 维护的结构化知识库' },
  { id: 'ocstatus', name: 'OpenClaw 状态', icon: 'fa-server', color: '#64748b', step: 0, desc: '网关与主 Agent 监控' },
